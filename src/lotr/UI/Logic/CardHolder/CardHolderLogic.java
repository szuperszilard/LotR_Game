...
public class CardHolderLogic {
	...
	private static ArrayList<Label_Clickable> listOfLabels = new ArrayList<>();
	...
	public static void fillCardHolders(ArrayList<Card> cards, ArrayList<Panel_CardHolder> cardHolderPanels, int chapter) throws IOException {
		...
		Label_Clickable_OverlapCheck.setMapOfOverlapDependencies(Label_Clickable_OverlapCheck.readMapOfOverlapDependenciesFromFile("D:\\Eclipse\\LotRGame\\chapter" + chapter + "Overlap.txt"));
